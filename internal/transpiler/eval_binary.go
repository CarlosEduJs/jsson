...
func (t *Transpiler) evalAddition(left, right any) (any, error) {
...
func (t *Transpiler) evalSubtraction(left, right any) (any, error) {
	lFloat, lIsFloat := toFloat(left)
...
func (t *Transpiler) evalMultiplication(left, right any) (any, error) {
	lFloat, lIsFloat := toFloat(left)
...
func (t *Transpiler) evalDivision(left, right any) (any, error) {
	lFloat, lIsFloat := toFloat(left)
...
func (t *Transpiler) evalModulo(left, right any) (any, error) {
