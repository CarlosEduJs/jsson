...
func LexerError(sourceFile string, line, col int, format string, args ...any) string {
...
func ParserError(sourceFile string, line, col int, format string, args ...any) string {
	msg := fmt.Sprintf(format, args...)
...
func TranspilerError(sourceFile string, line, col int, format string, args ...any) string {
	msg := fmt.Sprintf(format, args...)
...
func RangeBoundsNotIntegers(start, end any) string {
...
func StepNotInteger(step any) string {
...
func UnsupportedBinaryOp(left any, op string, right any) string {
...
func UnsupportedComparison(left, right any) string {
